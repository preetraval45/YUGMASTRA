    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 p-8">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-lg px-6 py-3 border border-purple-500/30">
            <p className="text-sm text-gray-300">Generation</p>
            <p className="text-3xl font-bold text-white font-mono">#{generation}</p>
            <p className="text-xs text-purple-300 animate-pulse">Evolving...</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div className="bg-white/10 backdrop-blur-lg rounded-lg p-6 border border-blue-500/30 hover:border-blue-500/50 transition-all">
          <div className="flex items-center gap-3 mb-4">
            <div className="p-3 bg-blue-500/20 rounded-lg animate-pulse">
              <TrendingUp className="w-6 h-6 text-blue-400" />
            </div>
            <div>
              <p className="text-sm text-gray-300">Nash Distance</p>
              <h3 className="text-3xl font-bold text-white font-mono">{nashDistance.toFixed(3)}</h3>
            </div>
          </div>
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-400">to equilibrium</span>
          </div>
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-lg p-6 border border-purple-500/30 hover:border-purple-500/50 transition-all">
          <div className="flex items-center gap-3 mb-4">
            <div className="p-3 bg-purple-500/20 rounded-lg">
              <Users className="w-6 h-6 text-purple-400" />
            </div>
            <div>
              <p className="text-sm text-gray-300">Strategy Diversity</p>
              <h3 className="text-3xl font-bold text-white">High</h3>
            </div>
          </div>
          <div className="flex items-center gap-2 text-sm">
            <span className="text-purple-400">127 unique</span>
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-lg p-6 border border-red-500/30 hover:border-red-500/50 transition-all">
          <div className="flex items-center gap-3 mb-4">
            <div className="p-3 bg-red-500/20 rounded-lg">
              <Flame className="w-6 h-6 text-red-400 animate-pulse" />
            </div>
            <div>
              <p className="text-sm text-gray-300">Red Win Rate</p>
              <h3 className="text-3xl font-bold text-white font-mono">{redWinRate.toFixed(1)}%</h3>
            </div>
          </div>
          <div className="flex items-center gap-2 text-sm">
            <span className={`${redWinRate > 50 ? 'text-red-400' : 'text-blue-400'}`}>
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-lg p-6 border border-green-500/30 hover:border-green-500/50 transition-all">
          <div className="flex items-center gap-3 mb-4">
            <div className="p-3 bg-green-500/20 rounded-lg">
              <Target className="w-6 h-6 text-green-400" />
            </div>
            <div>
              <p className="text-sm text-gray-300">Blue Detection</p>
              <h3 className="text-3xl font-bold text-white font-mono">{blueDetection.toFixed(1)}%</h3>
            </div>
          </div>
          <div className="flex items-center gap-2 text-sm">
            <span className={`${blueDetection > 50 ? 'text-green-400' : 'text-red-400'}`}>
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-white">Red Team</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-4 h-4 bg-gradient-to-r from-blue-600 to-blue-400 rounded" />
              <span className="text-sm text-white">Blue Team</span>
            </div>
          </div>
        </div>
        <div className="relative h-96 bg-black/20 rounded-lg p-4">
          {/* Grid lines */}
            ...
            {winRateHistory.map((rate, i) => {
              ...
              return (
                <div key={i} className="flex-1 flex flex-col justify-end gap-0.5 group relative">
                  ...
                  />
                  {/* Tooltip on hover */}
                  <div className="absolute bottom-full mb-2 left-1/2 transform -translate-x-1/2 hidden group-hover:block bg-black/90 text-white text-xs px-2 py-1 rounded whitespace-nowrap">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        <div className="bg-white/10 backdrop-blur-lg rounded-lg p-6 border border-red-500/30">
          ...
          <div className="space-y-4">
            <div>
              <div className="flex justify-between text-sm mb-2">
                <span className="text-gray-300">Average Attack Success</span>
                <span className="font-semibold text-white font-mono">65.2%</span>
              </div>
            ...
            <div>
              <div className="flex justify-between text-sm mb-2">
                <span className="text-gray-300">Best Agent Performance</span>
                <span className="font-semibold text-white font-mono">82.7%</span>
              </div>
              <div className="h-3 bg-gray-700 rounded-full overflow-hidden">
            ...
            <div>
              <div className="flex justify-between text-sm mb-2">
                <span className="text-gray-300">Strategy Diversity</span>
                <span className="font-semibold text-white font-mono">70.3%</span>
              </div>
              <div className="h-3 bg-gray-700 rounded-full overflow-hidden">
          ...
          <div className="mt-6 pt-6 border-t border-white/10">
            <h3 className="text-sm font-semibold text-white mb-3">Evolved Attack Strategies:</h3>
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-lg p-6 border border-blue-500/30">
          ...
          <div className="space-y-4">
            <div>
              <div className="flex justify-between text-sm mb-2">
                <span className="text-gray-300">Average Detection Rate</span>
                <span className="font-semibold text-white font-mono">58.4%</span>
              </div>
              <div className="h-3 bg-gray-700 rounded-full overflow-hidden">
            ...
            <div>
              <div className="flex justify-between text-sm mb-2">
                <span className="text-gray-300">Best Agent Performance</span>
                <span className="font-semibold text-white font-mono">75.9%</span>
              </div>
              <div className="h-3 bg-gray-700 rounded-full overflow-hidden">
            ...
            <div>
              <div className="flex justify-between text-sm mb-2">
                <span className="text-gray-300">Defense Diversity</span>
                <span className="font-semibold text-white font-mono">65.8%</span>
              </div>
              <div className="h-3 bg-gray-700 rounded-full overflow-hidden">
          ...
          {/* Top strategies */}
          <div className="mt-6 pt-6 border-t border-white/10">
            <h3 className="text-sm font-semibold text-white mb-3">Learned Defense Patterns:</h3>
            <div className="space-y-2">
              {[
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-4 bg-white/5 rounded-lg">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="font-semibold text-white">Equilibrium Status</h3>
            </div>
            <p className="text-2xl font-bold text-purple-400 mb-1">Approaching</p>
            <p className="text-sm text-gray-400">Distance: {nashDistance.toFixed(3)} (target: &lt; 0.10)</p>
            <div className="mt-3 flex items-center gap-2">
              ...
              <span className="text-xs text-gray-400">{((1 - nashDistance / 0.5) * 100).toFixed(0)}%</span>
            </div>
          </div>
          ...
          <div className="p-4 bg-white/5 rounded-lg">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="font-semibold text-white">Learning Rate</h3>
            </div>
            <p className="text-2xl font-bold text-green-400 mb-1">Active</p>
            <p className="text-sm text-gray-400">Both teams improving steadily</p>
          ...
          <div className="p-4 bg-white/5 rounded-lg">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="font-semibold text-white">Predicted Winner</h3>
            </div>
            <p className="text-2xl font-bold text-yellow-400 mb-1">Balanced</p>
            <p className="text-sm text-gray-400">Converging to 50/50 split</p>
