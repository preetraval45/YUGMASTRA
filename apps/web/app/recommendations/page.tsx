  ...
  return (
    <div className="min-h-screen bg-background p-8">
      ...
      <div className="mb-8">
        ...
        {/* Info Banner */}
        <div className="bg-gradient-to-r from-primary/20 to-purple-500/20 border border-primary/30 rounded-lg p-4 mb-6">
          <div className="flex items-start gap-3">
            <Eye className="w-5 h-5 text-primary mt-0.5" />
            <div>
              <h3 className="font-semibold mb-1">What This Page Shows</h3>
